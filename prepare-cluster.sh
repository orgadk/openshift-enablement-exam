...
ansible nodes -b -i hosts -m shell -a "yum update -y && yum install -y docker-1.12.6 wget git net-tools bind-utils iptables-services bridge-utils bash-completion kexec-tools sos psacct"
